...
int main() {
  ...
  //  std::cin.get(); // Ждет нажатия клавиши
    ...
    game.alien_frames_per_move = 60; // Движение раз в 20 кадров (1 секунда при 60 FPS)
